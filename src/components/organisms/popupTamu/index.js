...
import Beautiful  from '../../../assets/audio/khitan.mp3';
import AOS from 'aos';
...
const PopupTamu = ({play,audioRef,setRelatif}) => {
  ...
  return (
    <div className={`thumb`} style={{opacity:open, top:top}}>
            <p className="undang">Syukuran Khitanan</p>
            <p className="pengantin">Kavin</p>
            <p className="tanggal">Minggu, 02 November 2025</p>
            <div className="tamu">
                <p>Kepada Yth. <br/>
                    Bpk/Ibu/Saudara/i</p> 
