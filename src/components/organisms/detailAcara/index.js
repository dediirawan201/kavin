    ...
    <section className="detail-acara" id={`content${id}`}>
            ...
            <div className="acara">
                <div className="acara-1" data-aos="fade-left">
                    <h1>Tasyakuran Khitan</h1>
                    <p>Minggu, 02 November 2025 <br/>
                    08:00 - Selesai <br/> 
                    <strong>Kediaman Keluarga Asep Supian</strong><br/>
                    Jl. Bacang Raya RT 03/RW 04 No.50 Kel. Pekayon Jaya Kec.Bekasi Selatan</p>
                    <div className="map-live">
                    <a  href="https://maps.app.goo.gl/vV7T6zxkX5XKTVd78" terget="_blank" role="button" tabindex="-1" className="btn">
