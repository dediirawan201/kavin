...
const Hero = ({id}) => {
  ...
  return (
        <section  className="hero" data-aos="fade-bottom" data-aos-duration="2000" id={`content${id}`} > 
            ...
            <p className="title" data-aos="fade-up" data-aos-duration="3000">Tasyakuran Khitan</p>
            <h1 data-aos="zoom-in" data-aos-duration="3000" className="nama-pasangan">Kavin Ardana Abiputra Supian</h1>
            <p className="tanggal" data-aos="fade-down-left" data-aos-duration="3000">Minggu, 02 November 2025</p>
            ...
            <Coutdown/>
            <span className="inisial" data-aos="fade-up-left" data-aos-duration="3000">- Kavin -</span>
